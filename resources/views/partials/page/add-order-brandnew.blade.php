<div class="row">
    ...
    <div class="col-6 mb-3">
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="currentPrice" placeholder="Username" value="{{ "
                P " . $product->currentPrice() }}" readonly>
        </div>
    </div>
</div>
<form action="{{ route('add-order-detail') }}" method="POST">
    ...
    <input type="hidden" name="price" id="price" value="{{ $product->currentPrice() }}" readonly>
    <div class="col-12 mb-3">
        <div class="input-group">
            ...
            <input type="text" class="form-control text-center" id="quantity" name="quantity" value="0" readonly>
